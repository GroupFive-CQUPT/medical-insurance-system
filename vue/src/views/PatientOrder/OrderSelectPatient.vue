<template>
  <div class="diagnosis-patient">
    ...
    <div class="action-buttons">
      <el-button type="primary" @click="addDrugOrder">增加药品处方医嘱</el-button>
      <el-button type="primary" @click="addMedicalItemsOrder">增加诊疗项目医嘱</el-button>
      <el-button type="primary" @click="addServiceOrder">增加医疗服务医嘱</el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    addDrugOrder(row) {
      this.$router.push({
        path:"/PatientOrder/DrugOrder",
        query:{patientId:row.patientId,patientName:row.patientName},
      })
    },
    // 增加诊疗项目医嘱
    addMedicalItemsOrder(row) {
      this.$router.push({
        path:"/PatientOrder/MedicalItemsOrder",
        query:{patientId:row.patientId,patientName:row.patientName},
      })
    },
    // 增加
    addServiceOrder(row) {
      this.$router.push({
        path:"/PatientOrder/ServiceOrder",
        query:{patientId:row.patientId,patientName:row.patientName},
      })
    },
    // 获取患者列表
